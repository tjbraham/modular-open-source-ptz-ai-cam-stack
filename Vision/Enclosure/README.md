...
The top of the tower integrates the bottom bracket into the enclosure itself for the pan servo and bracket assembly found in the `bracket_files` directory.